<template>
  <div>
    <div style="margin-bottom:10px">
      <el-input style="width: 300px" placeholder="请输入用户名" v-model="params.username"></el-input>
...
<!--scope.row当前行数据 跳转页面         -->
          <el-button type="warning" icon="el-icon-edit" circle @click="$router.push('/editAdmin?id=' + scope.row.id)" ></el-button>
          <el-popconfirm
